...
namespace Model
{
    public class EmployeeDetails
    {
        ...
        public EmployeeDetails(string first_Name, string last_Name,string gender,string email,long contact_Number,string user_Id,string password,long salary,string designation,string permanent_Address,string correspondence_Address,string login_type, bool isActive,DateTime createdOn,string createdBy,string approvedBy,DateTime approvedOn)
        {
